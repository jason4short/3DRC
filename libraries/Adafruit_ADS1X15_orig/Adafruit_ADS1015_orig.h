...
protected:
 ...
 public:
  Adafruit_ADS1015_orig(uint8_t i2cAddress = ADS1015_ADDRESS);
  void begin(void);
...
class Adafruit_ADS1115 : public Adafruit_ADS1015_orig
{
 public:
